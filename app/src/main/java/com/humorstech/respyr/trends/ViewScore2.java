...
public class ViewScore2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarColor statusBarColor= new StatusBarColor(  ViewScore2.this);
                        ...
                        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                            ...
                            if (response.equals("0")){
                                if (datCount==1){
                                    ...
                                    Toast.makeText(ViewScore2.this, "0 records founds", Toast.LENGTH_SHORT).show();
                                    setCurrentDate();
                                }
                            }else{
                                performMainChart(response);
    ...
    private void performTestTimeLine(String jsonData){
        ...
        TimeLineAdapter  adapter = new TimeLineAdapter(healthDataList, ViewScore2.this, dataKey);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Animatoo1.animateSlideRight(ViewScore2.this);
    }
}