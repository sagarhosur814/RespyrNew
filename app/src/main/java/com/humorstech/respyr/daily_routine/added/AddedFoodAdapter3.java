...
public class AddedFoodAdapter3 extends RecyclerView.Adapter<AddedFoodAdapter3.ViewHolder> {
    private List<AddedFoodData> foodItems;
    private Context context;

    public AddedFoodAdapter3(List<AddedFoodData> foodItems, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.added_meals2, parent, false);
