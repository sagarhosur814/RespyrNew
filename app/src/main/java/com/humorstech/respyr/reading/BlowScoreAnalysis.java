...
public class BlowScoreAnalysis {
    ...
    public static String[] subTitles = {"Your respiratory risk level is low which is great! Let’s continue to track your lifestyle to maintain it.","Your respiratory risk level is moderate and needs some work. Go the extra mile! Modify your lifestyle to see better results." ,"Your respiratory risk level is high & might be a cause of concern. Give it your all! Modify your lifestyle to get back on track."};




    @SuppressLint("SetTextI18n")
    public static void setBlow(Context context, double score, String profileName, RoundedProgressBar roundedProgressBar,
